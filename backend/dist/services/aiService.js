...
exports.generateAIInsuranceMatch = exports.analyzeImageWithGemini = void 0;
...
class AIService {
    ...
    async analyzeImageWithGemini(imagePath, description = '', symptoms = []) {
...
`;
    ...
    async generateAIInsuranceMatch(query, state) {
...
`;
    ...
    parseImageAnalysisResponse(text) {
        try {
    ...
    parseInsuranceResponse(text, query) {
        try {
            const jsonMatch = text.match(/\{[\s\S]*\}/);
            if (jsonMatch) {
                const parsed = JSON.parse(jsonMatch[0]);
    ...
    getFallbackInsuranceProvider(query, state) {
    ...
    generateProviderNameFromQuery(query) {
...
const analyzeImageWithGemini = (imagePath, description, symptoms) => aiService.analyzeImageWithGemini(imagePath, description, symptoms);
exports.analyzeImageWithGemini = analyzeImageWithGemini;
const generateAIInsuranceMatch = (query, state) => aiService.generateAIInsuranceMatch(query, state);
exports.generateAIInsuranceMatch = generateAIInsuranceMatch;
