...
exports.seedInsuranceProviders = void 0;
...
const seedInsuranceProviders = async () => {
    try {
        const existingCount = await InsuranceProvider_1.default.countDocuments();
        if (existingCount === 0) {
            console.log('Seeding insurance providers...');
            await InsuranceProvider_1.default.insertMany(sampleInsuranceProviders);
...
exports.seedInsuranceProviders = seedInsuranceProviders;
